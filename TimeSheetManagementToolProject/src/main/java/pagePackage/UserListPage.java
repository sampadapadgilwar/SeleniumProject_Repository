...
public class UserListPage {
	...
	private WebElement passwordTextRetypeTB;
	...
	@FindBy(xpath = "(//a[contains(text(),'System,')]/ancestor::tbody/descendant::a)[1]")
	private WebElement userCreatedLink;
	@FindBy(xpath = "//input[@value='Delete This User']")
	private WebElement DeleteUserButton;
	@FindBy(xpath = "//*[@id='right12']")
	private WebElement ModifyTimeTrack;
	@FindBy(xpath = "//*[@id='right2']")
	private WebElement manageCust;
	@FindBy(xpath = "//*[@id='right1']")
	private WebElement manageReport;
	@FindBy(xpath = "//*[@id='right5']")
	private WebElement manageUsers;
	@FindBy(xpath = "//*[@id='right7']")
	private WebElement manageBilling;
