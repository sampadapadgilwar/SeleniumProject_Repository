...
public class TaskListPage {
	...
	private WebElement OpenTaskModule;
	@FindBy(xpath = "//a[.='Completed Tasks']")
	private WebElement CompletedTaskModule;
	@FindBy(xpath = "//a[.='Projects & Customers']")
	private WebElement Projects_CustomersModule;
	@FindBy(xpath = "//a[.='Archives']")
	private WebElement ArchivesModule;
	@FindBy(xpath = "//input[@value='Create New Customer']")
	private WebElement CNcustomer;
	@FindBy(xpath = "//input[@value='Create New Project']")
	private WebElement CNproject;
	...
	@FindBy(xpath = "//*[@name='createProjectSubmit']")
	private WebElement createProjectButton;
	@FindBy(xpath = "//input[@onclick='cancelProjectCreation();']")
	private WebElement cancelButton;
	@FindBy(xpath = "//label[text()='Create a new project for this customer']")
