...
public class ValidLoginTestCase extends BaseTest {
	...
	public void validTestCase() throws IOException, InterruptedException {
		...
		ulp.createUserMethod(flib.readExcelData(EXCEL_PATH, "mgrdata", 1, 0), flib.readExcelData(EXCEL_PATH, "mgrdata", 1, 1),
				flib.readExcelData(EXCEL_PATH, "mgrdata", 1, 2), flib.readExcelData(EXCEL_PATH, "mgrdata", 1, 3));
		ulp.selectCheckBox();
